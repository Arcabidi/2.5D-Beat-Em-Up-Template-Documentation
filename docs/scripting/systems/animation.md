...
The non-code files in this section are at `Assets/Arcabidi/BeatEmUpTemplate/Animation`.
...
The code files in this section are at `Assets/Arcabidi/BeatEmUpTemplate/Scripting/Systems/08 - Animation`.
